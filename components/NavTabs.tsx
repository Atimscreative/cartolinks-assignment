...
export default function NavTabs() {
  ...
  return (
    <Tabs
      value="home"
      defaultValue="home"
      className="h-auto p-1 bg-[#f5f5f5] rounded-2xl dark:bg-neutral-900 backdrop-blur-2xl"
    >
      <TabsList className="h-auto bg-transparent">
        <TabsTrigger
          value="home"
          className="hover:bg-[#f5f5f5] group text-black data-[state=active]:bg-white rounded-xl data-[state=active]:shadow-[0_1px_4px_0px_rgba(0,0,0,0.075)] w-14 h-10 px-4 dark:data-[state=active]:text-black dark:data-[state=active]:!bg-white"
        >
          <svg
            width="18"
            height="18"
        ...
        <TabsTrigger
          value="image"
          className="hover:bg-[#f5f5f5] text-black data-[state=active]:bg-white
                 rounded-xl data-[state=active]:shadow-[0_1px_4px_0px_rgba(0,0,0,0.075)] dark:shadow-none w-14 h-10 px-4 dark:hover:bg-neutral-800"
        >
          <svg
            width="18"
            height="18"
